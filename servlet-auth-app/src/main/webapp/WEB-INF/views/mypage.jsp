		...
		<div class="main-container">
			<div>
				<form class="mypage-form" action="/ssa/api/mypage/edit" method="post" >
					<h1>Mypage</h1>
					<input class="mypage-input" name="username" placeholder= <%= user.getUsername() %> disabled>
					<input class="mypage-input"name="name" placeholder= <%= user.getName() %>> 
					<input class="mypage-input" name="email" placeholder=<%= user.getEmail() %>>
					<button class="submit-button">변경하기</button>
				</form>
				<form class="mypage-form" action="/ssa/api/mypage/password/edit" method="post">
					<h1>Edit Passsword</h1>

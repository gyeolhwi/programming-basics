...
function App() {
    ...
    */
    ...
    const accessTokenValid = useQuery(
        ...
        },
        {
            ...
            onSuccess: response => {
                ...
                for (let permitPath of permitAllPaths) {
    ...
    const userInfo = useQuery(
        ...
        {
            enabled: accessTokenValid.isSuccess && accessTokenValid.data?.data, // 요청에 문제가없고 data가 있다면 요청 보내기
            refetchOnWindowFocus: false
        }
    )

...
public class CommentService {
    ...
    public RespCommentDto getComments(Long boardId) {
        return RespCommentDto.builder()
                .comments(commentMapper.findAllByBoardId(boardId)) // 리스트로들어옴
    ...
    public void editComment(ReqUpdateCommentDto commentDto) {
        accessCheck(commentDto.getId());
        commentMapper.updateById(commentDto.toEntity());
    }

...
function ModifyQuill() {
    ...
    const handleModifySubmitOnClick2 = async () => {
        try {
    ...
    return (
        <div css={layout}>
            ...
            <div css={title}>
                <input type="text" name="title" onChange={handleTitleInputOnChange} value={board.title} placeholder="게시글의 제목을 입력하세요." />
                <button onClick={handleModifySubmitOnClick}>수정</button>
                <button onClick={handleModifySubmitOnClick}>취소</button>
            </div>
